...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plugin_page__ = __webpack_require__(1961);
...
var CoreSitePluginsPluginPage = /** @class */ (function () {
    ...
    CoreSitePluginsPluginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-core-site-plugins-plugin',template:/*ion-inline-start:"/Users/bourne/Documents/Documents – Bourne’s MacBook Air/Projects/moodlemobiledirectory/src/core/siteplugins/pages/plugin-page/plugin-page.html"*/'<ion-header>\n    <ion-navbar core-back-button>\n        <ion-title>{{ title | translate }}</ion-title>\n\n        <ion-buttons end>\n            <!-- If the site plugin defines some buttons using core-nav-buttons, they will be added here. -->\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n<ion-content>\n    <ion-refresher [enabled]="content && content.dataLoaded" (ionRefresh)="refreshData($event)">\n        <ion-refresher-content pullingText="{{ \'core.pulltorefresh\' | translate }}"></ion-refresher-content>\n    </ion-refresher>\n    <core-site-plugins-plugin-content [component]="component" [method]="method" [args]="args" [initResult]="initResult" [data]="jsData"></core-site-plugins-plugin-content>\n</ion-content>\n'/*ion-inline-end:"/Users/bourne/Documents/Documents – Bourne’s MacBook Air/Projects/moodlemobiledirectory/src/core/siteplugins/pages/plugin-page/plugin-page.html"*/,
        }),

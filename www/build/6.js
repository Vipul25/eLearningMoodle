...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__text__ = __webpack_require__(1966);
...
var CoreViewerTextPage = /** @class */ (function () {
    ...
    CoreViewerTextPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-core-viewer-text',template:/*ion-inline-start:"/Users/bourne/Documents/Documents – Bourne’s MacBook Air/Projects/moodlemobiledirectory/src/core/viewer/pages/text/text.html"*/'<ion-header>\n    <ion-navbar core-back-button>\n        <ion-title>{{ title }}</ion-title>\n\n        <ion-buttons end>\n            <button ion-button icon-only (click)="closeModal()" [attr.aria-label]="\'core.close\' | translate">\n                <ion-icon name="close"></ion-icon>\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n<ion-content padding>\n    <core-format-text [text]="content" [component]="component" [componentId]="componentId"></core-format-text>\n\n    <ion-card *ngIf="files && files.length">\n        <core-file *ngFor="let file of files" [file]="file" [component]="component" [componentId]="componentId"></core-file>\n    </ion-card>\n</ion-content>\n'/*ion-inline-end:"/Users/bourne/Documents/Documents – Bourne’s MacBook Air/Projects/moodlemobiledirectory/src/core/viewer/pages/text/text.html"*/,
        }),
